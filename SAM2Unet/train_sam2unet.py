...
def parse_args():
    ...
    p.add_argument("--model", type=str, default="sam2unet",
                   choices=["unet", "echocare", "sam2unet"])
    p.add_argument("--opt", type=str, default='sam2unet',
    ...
    # ==================== 新增SAM2UNet参数 ====================
    p.add_argument("--hiera-path", type=str, default='/opt/data/private/SH/dataset/checkpoints/sam2_hiera_large.pt',
                   help="Path to SAM2 pretrained Hiera checkpoint (required for sam2unet)")

    p.add_argument("--sam2-img-size", type=int, default=352,
                   help="Input image size for SAM2UNet (default: 352)")
    ...
    p.add_argument("--save-path", type=str, default="./checkpoints_baseline_sam2unet_baseplus")
