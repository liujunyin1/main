...
def parse_args():
    ...
    p.add_argument("--data-json", type=str, default='/opt/data/private/fb/dataset/FETUS2026/Val/valid.json',
                   help="JSON for inference (image paths; view ids required if --mask-mode oracle)")
    p.add_argument("--ckpt", type=str, default='/opt/data/private/SH/race/FETUS26/SAM2Unet/checkpoints_baseline_sam2unet_tiny1/best.pth', help="checkpoint path (.pth)")
    p.add_argument("--out-dir", type=str, default="./sam2unet_output")
    ...
    p.add_argument("--amp", default=True, help="enable autocast")
