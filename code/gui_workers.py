...
class DataEditWorker(QRunnable):
    ...
    def __init__(self, current_result, signals, ids_to_remove=None, point_to_add=None, point_to_modify=None):
    ...
    def run(self):
        try:
            ...
            # 4. 调用分析函数 (这是唯一的耗时操作)
            new_analysis_data = analyze_central_structure(new_inlier_data, h, w)
