...
def ToTensor_sam_bs(image, label):     # [B, 1024, 1024]
    ...
    label_batch_inshape = label_batch_inshape.reshape(label_batch_inshape.shape[0], label_batch_inshape.shape[1], volume_batch_inshape.shape[2]).astype(np.int64)  # [B, 1024, 1024] <-----此处做了修改
