...
def build_sam_vit_b(image_size,seg_num_classes, cls_num_classes, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None):
    return _build_sam(
...
def _build_sam(
    ...
    sam = Sam(
        ...
        mask_decoder=MaskDecoder(
            ...
            num_multimask_outputs=seg_num_classes,
